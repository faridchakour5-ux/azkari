...
- URL publique de l'app : `https://www.salatee.org/`
- URL politique de confidentialité : `https://www.salatee.org/privacy.html`

## 1. Générer le package Android (le plus simple : PWABuilder)
1. Aller sur https://www.pwabuilder.com
2. Coller `https://www.salatee.org/` → **Start**.
...
3. Pousser → le fichier sera servi sur `https://www.salatee.org/.well-known/assetlinks.json`.
...
- Remplir les sections obligatoires :
  - **Privacy policy** : `https://www.salatee.org/privacy.html`
